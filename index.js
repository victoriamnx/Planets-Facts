...
overviewButton.addEventListener("click", () => {
  planetText.innerHTML = `
        ...
        `;
  planetImage.src = "./assets/planet-mercury.svg";
...
internalStructureButton.addEventListener("click", () => {
  planetText.innerHTML = `
        ...
        System at 5.427 <br />g/cm3 , only slightly less than Earth's density. Source :
        Wikipedia
        `;
  planetImage.src = "./assets/planet-jupiter-internal.svg";
...
surfaceGeologyButton.addEventListener("click", () => {
  planetText.innerHTML = `
        ...
        than either <br />Mars's or the Moon’s. Source : Wikipedia
        `;
  planetImage.src = "./assets/geology-mercury.png";
